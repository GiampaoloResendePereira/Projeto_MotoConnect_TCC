...
function RecuperacaoSenha() {
  ...
  return (
    <div className="container bg-light p-5">
      <h2 className="bg-dark text-white rounded p-3 mb-4">Recuperação de Senha</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="btn btn-danger">Enviar Email de Recuperação</button>
      </form>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form onSubmit={handleUpdateSenha}>
                  ...
                  <button type="submit" className="btn btn-danger">Salvar senha</button>
                </form>
              </div>
            </div>
          </div>
